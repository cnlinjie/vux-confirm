        ...
        data() {
            return {
                ...
                config: {
                    ...
                    UMEDITOR_HOME_URL: "http://localhost:8080/assets/plugins/umditor/"

                    //图片上传配置区
                    , imageUrl: "http://localhost:8080/" + "jsp/imageUp.jsp"             //图片上传提交地址
                    , imagePath: "http://localhost:8080/" + "jsp/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
...
//                    , initialFrameHeight: 320  //初始化编辑器高度,默认500
        ...
        mounted () {
            if (this.editor === null) {
                ...
                if (this.editor === null) {
                    this.$nextTick(() => {
                        _this.editor = UM.getEditor(_this.id, _this.config);
                    });
                }
            }
        },
