<template>
    <div style="width: 90%; margin: 0 auto">
        ...
        <div class="msg"><span>队伍名称：</span> <input />
        </div>
        <div class="msg"><span>队伍口号：</span> <input />
        </div>
        <div class="msg"><span>筹款目标：</span> <input  value="400"/>
    ...
    border: 1px dashed #704091; padding: 10px;">
            ...
            <div>2: 规定期间内，队长可更换同组队员，但须成员同意，
                逾期系统将无法进行“队员更换操作”</div>
            <div>3：队伍需在组队完成后缴交200元押金队伍才算真正成立,方可进行募捐</div>
        </div>
        <div class="button" @click="subteam">提交</div>
    </div>
